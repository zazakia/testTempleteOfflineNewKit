...
export const LoanEntity: EntityDefinition<Loan> = {
  name: 'loan',
  ui: { label: 'Loan', labelPlural: 'Loans', icon: 'ScrollText', routePath: 'loans', color: 'purple', showInNav: true, navOrder: 30 },
...
export const LoanApplicationEntity: EntityDefinition<LoanApplication> = {
  ...
  ui: { label: 'Loan Application', labelPlural: 'Loan Applications', icon: 'FileText', routePath: 'loan-applications', color: 'yellow', showInNav: true, navOrder: 30 },
  sync: { enabled: true, conflictStrategy: 'lww', priority: 'normal' },
...
export const PaymentEntity: EntityDefinition<Payment> = {
  name: 'payment',
  ui: { label: 'Payment', labelPlural: 'Payments', icon: 'Receipt', routePath: 'payments', color: 'green', showInNav: true, navOrder: 35 },
  sync: { enabled: true, conflictStrategy: 'lww', priority: 'critical' },
