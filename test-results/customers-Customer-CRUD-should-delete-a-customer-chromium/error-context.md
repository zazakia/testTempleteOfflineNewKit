...
- Name: customers.spec.ts >> Customer CRUD >> should delete a customer
- Location: e2e\customers.spec.ts:77:7
...
Expected substring: not "Delete Me"
Timeout: 5000ms
...
- main "Page content":
  ...
  - paragraph: Created 7/13/2026 · v1
  - button "Edit":
    - img
    - text: Edit
  - button "Delete":
  ...
  - term: Created by
  - definition: u1
  - term: Last updated by
  - definition: u1
  - dialog "Delete Customer":
    - heading "Delete Customer" [level=2]
    - paragraph: Are you sure you want to delete "Delete Me"? This action can be undone by an administrator.
    - button "Close":
      - img
    - button "Cancel"
